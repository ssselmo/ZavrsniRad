...
{
    public class AdminPrimaociViewModel : BaseViewModel
    {
        ...
        private async void OnInfoClicked(Primalac obj)
        {
            ...
            await Shell.Current.GoToAsync($"{nameof(AdminInfoPrimaociPage)}?{nameof(AdminInfoPrimaociViewModel.PrimalacId)}={obj.Id}");
